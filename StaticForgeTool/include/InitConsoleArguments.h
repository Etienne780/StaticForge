...
inline void InitConsoleArguments() {
	...
	auto& compressArg = CAM::RegisterConsoleArgument(ArgName::COMPRESS_NAMES, ArgName::COMPRESS_NAMES_SHORTNAME, ConsoleArgType::Bool);
	compressArg.SetEvaluationFunction(boolParser);
